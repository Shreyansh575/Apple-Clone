...
const Support = () => {
  ...
  return (
    <div className='bg-white mt-17'>
      ...
      <div className='mt-15'>
        <div>
            <div className='flex space-x-18      max-md:flex-wrap     max-md:px-5 justify-center max-md:justify-between  max-md:space-x-6'>
                {navdata.map((elem)=>{
                    return(
                        <div className='flex flex-col max-md:w-[30vw] justify-center'>
                            <div className='flex justify-center'>
      ...
      <div className='mt-31'>
        <div className='flex gap-10 max-md:grid px-35 max-md:px-5'>
            {boxdata.map((elem)=>{
                return(
                    <div className='w-[25vw] max-md:w-[90vw] h-[30vh] shadow-2xs z-20  rounded-4xl bg-[#f4f4f4]'>
                        <div className='flex justify-center'>
      ...
      <div>
        <div className='bg-[#f8f8f9]'>
            ...
            <div className='flex max-md:grid rounded-3xl bg-white max-md:ml-5 max-md:w-[88vw] max-md:h-[90vh] ml-50 max-md:p-1  w-[70vw]'>
                ...
                <div className='flex flex-col justify-center max-md:-mt-[150vh]'>
            ...
            <div className='flex rounded-3xl bg-white max-md:h-[67vh] ml-40 max-md:ml-1 max-md:grid  w-[80vw] max-md:w-[94vw]'>
                <div className='flex flex-col justify-center max-md:px-1 px-10'>
                    <div className='text-[50px] ml-10 leading-13 max-md:text-[40px] max-md:leading-10 font-[font7]'>Apple Repair and Service</div>
                    ...
                    <div className='mt-10 flex text-blue-600 max-md:mt-3 max-md:ml-10 hover:underline  px-10 '>Start a repair <ChevronRight/></div>
                </div>
                <img className='w-[40vw] md:rounded-r-3xl h-[70vh] max-md:w-[100vw] max-md:h-[40vh] max-md:object-contain max-md:rounded-b-4xl object-cover' src="https://support.apple.com/content/dam/edam/applecare/images/en_US/psp/psp_content/tile-feature-repair-and-service.image.large_2x.png" alt="" />
            </div>
            </div>
      ...
      <div className='h-screen '>
        ...
        <div className='flex justify-center max-md:grid gap-12 mt-20'>
            <div className='w-[23vw] max-md:w-[80vw]'>
                <img className='h-[33vh] max-md:min-w-[90vw] max-md:object-cover max-md:-ml-5 max-md:rounded-2xl' src="https://support.apple.com/content/dam/edam/applecare/images/en_US/psp/psp_content/content-block-apple-support.png" alt="" />
                <div className='mt-5'>
            ...
            <div className='w-[23vw]'>
                <img className='h-[33vh] max-md:min-w-[90vw] max-md:object-cover max-md:-ml-5 max-md:rounded-2xl' src="https://support.apple.com/content/dam/edam/applecare/images/en_US/psp/psp_content/tile-feature-round-youtube.png" alt="" />
                <div className='mt-5 max-md:-ml-5'>
                    <div className='text-[20px] text-center font-[font7] max-md:w-[90vw]'>Apple Support on YouTube</div>
                    <div className='text-center tetx-[22px] text-gray-800 max-md:w-[90vw]'>Watch videos to get the most out of the latest features, devices, and services.</div>
                    <div className='mt-4 text-center hover:cursor-pointer flex justify-center hover:underline text-blue-600 max-md:w-[90vw]'>Visit Apple Support on YouTube  &nbsp;  <ChevronRight /></div>
                </div>
            </div>
            ...
            <div className='w-[23vw]'>
                <img className='h-[33vh] max-md:min-w-[90vw] max-md:object-cover max-md:-ml-5 max-md:rounded-2xl' src="https://support.apple.com/content/dam/edam/applecare/images/en_US/psp/psp_content/tile-feature-round-todayatapple.png" alt="" />
                <div className='mt-5 max-md:-ml-5'>
                    <div className='text-[20px] text-center font-[font7] max-md:w-[90vw]'>Today at Apple</div>
                    <div className='text-center tetx-[22px] text-gray-800 max-md:w-[90vw]'>Learn, create, and be inspired in hands-on sessions at your Apple Store.</div>
                    <div className='mt-4 text-center hover:cursor-pointer flex max-md:w-[90vw] justify-center hover:underline text-blue-600'>Sign up  &nbsp;  <ChevronRight /></div>
                </div>
            </div>
        </div>
      </div>
