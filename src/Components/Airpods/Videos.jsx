...
useEffect(() => {
  ...
  return (
    <div className=''>
      <div className='relative   top-50  px-10 max-md:h-[100vh] max-md:px-1     overflow-y-hidden max-md:overflow-x-hidden  '>
        <div className=' shadow-2xl  '>
        <video autoPlay loop playsInline className='rounded-4xl max-md:min-h-[100vh] max-md:min-w-[50vw] object-cover relative' src="https://www.apple.com/105/media/us/airpods/2025/515ae144-8530-47d0-85d1-22a263f4b237/anim/hero/large.mp4"></video>
        </div>
        <div className='absolute max-md:-mt-76 -mt-50 ml-10'>
            <div className='text-7xl max-md:text-center max-md:text-6xl font-[font7]'>AirPods Pro 3</div>
            <div className='text-2xl max-md:text-center font-[font7]'>The world’s best in-ear Active Noise Cancellation.</div>
            <div className='text-xl max-md:text-center mt-10 font-[font7]'>$249</div>
        </div>
...
With Active Noise Cancellation $179
    ...
    <div className=''>
       ...
       <img src={data[index].img} className='h-[80vh] rounded-4xl absolute max-md:-ml-[85vw] -ml-[60vw] mt-10 max-md:h-[40vh] max-md:mt-50 ' alt="" />
       <div className='absolute left-10 max-md:left-5 max-md:text-center max-md:leading-5  max-md:mt-140 max-md:-ml-1 mt-130 ml-20'>
