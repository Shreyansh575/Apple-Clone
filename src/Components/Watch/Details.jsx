...
const Details = () => {
  ...
  return (
    ...
    <div  className='p-[5vw] px-[15vw] flex justify-center items-center max-md:px-3 z-800 absolute  backdrop-blur-[50px]'>
      <div className='h-[70vh] max-md:h-[88vh] rounded-4xl bg-[#c5cbc5] max-md:overflow-hidden w-[65vw] max-md:w-[94vw] '>
    <div className='flex justify-end mr-5 mt-5' onClick={()=>{
      naviagte('/watch')
    }}><CircleX /></div>
        <div>

          <div className='flex p-10 max-md:-mt-10 text-3xl font-[font7]'>{elem.feature}</div>
          <div className='flex px-10 -mt-8 max-md:text-[35px] text-7xl font-[font7]'>
            {elem.key}
          </div>
          <div className='flex px-10 mt-5   text-[22px] max-md:leading-7'>
            {elem.about}
          </div>
