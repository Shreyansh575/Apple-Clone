...
const Topimgslider = () => {
  ...
  return (
    <div>
      <div ref={rightRef} className='flex h-22  bg-blend-color-burn ml-40 mt-10 space-x-5'>
      ...
      }}  className='absolute z-20 bg-transparent left-0 bg-gray-400 rounded-full  -mt-13'><ChevronLeft size={50} /></div>
      <div onClick={()=>{
        setLscroll(true)
        console.log(Lscroll);
        
      }}  className='absolute z-20 bg-transparent right-0 bg-gray-400 rounded-full  -mt-13'><ChevronRight size={50} /></div>
    </div>
  )
}
